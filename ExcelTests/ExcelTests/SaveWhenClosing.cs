...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The SaveWhenClosing recording.
    /// </summary>
    [TestModule("7a336b3e-089b-4130-b4d4-a9dab001691a", ModuleType.Recording, 1)]
    public partial class SaveWhenClosing : ITestModule
    {
        /// <summary>
        ...
        static SaveWhenClosing instance = new SaveWhenClosing();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public SaveWhenClosing()
        {
        ...
        /// </summary>
        public static SaveWhenClosing Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'Book1Excel.Save' at Center.", repo.Book1Excel.SaveInfo, new RecordItemIndex(1));
            repo.Book1Excel.Save.Click();
